...
Namespace GridContextMenu
	Public Class MainViewModel
		...
		Private privateDeleteCommand As DelegateCommand(Of Item)
		Public Property DeleteCommand() As DelegateCommand(Of Item)
			Get
				Return privateDeleteCommand
			End Get
			Private Set(ByVal value As DelegateCommand(Of Item))
		...
		Private privateDuplicateCommand As DelegateCommand(Of Item)
		Public Property DuplicateCommand() As DelegateCommand(Of Item)
			Get
				Return privateDuplicateCommand
			End Get
			Private Set(ByVal value As DelegateCommand(Of Item))
				privateDuplicateCommand = value
			End Set
		End Property
